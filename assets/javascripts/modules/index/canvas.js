...
ocas.width = canvas.width = document.getElementsByClassName('prize')[0].offsetWidth;
ocas.height = canvas.height = document.getElementsByClassName('prize')[0].offsetHeight;
var bigbooms = [];
